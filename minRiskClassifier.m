function [ result ] = minRiskClassifier( mode, data, classifier, lambda )
%MINERRORCLASSIFIER Summary of this function goes here
%   Detailed explanation goes here

if size(data.x, 2) > 2
    disp('Only allowed for 2 dimensional data');
else
        ...
        case 'evaluate'
            ...
            for i = 1 : numData
                ...
                for j = 1 : numUniqueClasses
                    ...
                    % Add lambda to the calculation
                    g = abs(lambda(1,j) - lambda(2, j)) * g;
